...
# pt = product type
category = first.selectbox(label='Kategori Produk : ', options=skincare['product_type'].unique())
...
# pilih keluhan
prob = st.multiselect(label='Permasalahan Kulit Kamu : ',
...
def skincare_recommendations(nama_produk, similarity_data=cosine_sim_df,
                             items=skincare[['product_name', 'product_href', 'price', 'description']], k=5):
